...
class LLMManager:
    @staticmethod
    def get_llm(backend_mode: Optional[str] = None, model_name: Optional[str] = None) -> LLMInterface:
        ...
        if effective_backend == "api":
            ...
            return OpenAIModule(api_key=settings.openai_api_key, model_name=effective_model)
            ...
            return NVIDIAModule(api_key=settings.nvidia_api_key, model_name=effective_model)
